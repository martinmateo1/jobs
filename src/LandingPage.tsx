...
import { CloudArrowUpIcon, CheckIcon, XMarkIcon, LockClosedIcon, ServerIcon } from '@heroicons/react/20/solid'
...
const features = [
    {
      name: 'Publicación ilimitada.',
      description:
        'No hay fecha de vencimiento, mantené tu oferta visible todo el tiempo que desees.',
      icon: CloudArrowUpIcon,
    },
    {
      name: 'Ahorro de costos.',
      description: 'Paga solo una vez, sin tarifas adicionales por extensión.',
      icon: LockClosedIcon,
    },
    {
      name: 'Mayor alcance.',
      description: 'Compartí tu oferta en todas las redes sociales para atraer más candidatos con nuestro módulo de sharing.',
      icon: ServerIcon,
    },
    {
        name: 'Fácil gestión.',
        description: 'Centralizá todas tus aplicaciones en una plataforma intuitiva y fácil de usar.',
        icon: ServerIcon,
      },
  ]
  const usps = [
    {
      name: 'Publicación sin fecha de vencimiento.',
      description:
        'Mantené tus ofertas visibles el tiempo que desees sin tener que pagar de nuevo.',
      icon: CloudArrowUpIcon,
    },
    {
      name: 'Diseño profesional y atractivo.',
      description: 'Presentá cada búsqueda con una estética que destaque y atraiga candidatos de calidad.',
      icon: LockClosedIcon,
    },
    {
        name: 'Fácil de compartir y promocionar.',
        description: 'Paga solo una vez, sin tarifas adicionales por extensión.',
        icon: LockClosedIcon,
      },
      {
        name: 'Sin costos recurrentes.',
        description: 'Olvidate de los pagos continuos; publicá una sola vez y mantené la oferta activa.',
        icon: LockClosedIcon,
      },
    {
      name: 'Mayor alcance.',
  ...
  const steps = [
    {
      name: 'Creá tu oferta de empleo.',
      description:
        'Llená un formulario simple con los detalles del puesto.',
      icon: CloudArrowUpIcon,
    },
    {
      name: 'Compartí en redes sociales.',
      description: 'Con un solo clic, tu búsqueda estará disponible en las principales redes sociales.',
      icon: LockClosedIcon,
    },
    {
      name: 'Recibí aplicaciones en un solo lugar.',
      description: 'Centralizá todas las aplicaciones en nuestra plataforma, sin complicaciones.',
      icon: ServerIcon,
    },
  ]
...
return (
    <div>
      ...
      <p className="text-sm leading-6 text-gray-900">
        <a href="#">
          ...
          Por nuestro lanzamiento, estamos ofreciendo un <strong>5% de descuento</strong> en todos nuestros planes<span aria-hidden="true">&rarr;</span>
        </a>
      </p>
    ...
    <div className="">
      <div className="relative isolate overflow-hidden bg-gradient-to-b from-indigo-100/20">
        <div className="mx-auto max-w-7xl pb-24 pt-0 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-40">
                ...
                <div className="relative px-6 pt-8 sm:pt-16 md:pl-16 md:pr-0">
                  <div className="mx-auto max-w-2xl md:mx-0 md:max-w-none">
                    <div className="w-screen overflow-hidden rounded-tl-xl bg-gray-900">
                      ...
                      <div className="px-6 pb-14 pt-6">'<p></p>''<p></p>''<p></p>''<p></p>''<p></p>''<p></p>''<p></p>''<p></p>''<p></p>''<p></p>''<p></p>''<p></p>'</div>
                    </div>
                  </div>
                  <div
    ...
    <div className="overflow-hidden bg-white py-24 sm:py-32" >
      <div className="mx-auto max-w-7xl px-6 lg:px-8" id="por-que-finejob">
    ...
    <div className="bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Simplificamos tu trabajo en 3 pasos</h2>
          <p className="mt-6 text-lg leading-8 text-gray-300">
          Desde la creación hasta la selección, todo en un solo lugar.
          </p>
        </div>
    ...
    <div className="bg-white py-24 sm:py-32" id="beneficios">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Beneficios</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Ventajas exclusivas para recruiters.</p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Maximizá tu alcance y optimizá tu presupuesto de reclutamiento.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
        <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
          {usps.map((usp) => (
            <div key={usp.name} className="relative pl-9">
              <dt className="inline font-semibold text-gray-900">
                <usp.icon aria-hidden="true" className="absolute left-1 top-1 h-5 w-5 text-indigo-600" />
                {usp.name}
              </dt>{' '}
              <dd className="inline">{usp.description}</dd>
            </div>
          ))}
        </dl>
      </div>
      ...
      <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-24 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            Potenciá tus búsquedas.
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-300">
            No pierdas más tiempo con publicaciones limitadas. Aprovechá nuestra plataforma y recibí candidatos sin restricciones ni costos ocultos.
            </p>
