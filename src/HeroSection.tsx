      ...
      <main>
        <div className="relative isolate">
          ...
          <div className="overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-16 sm:pt-60 lg:px-8 lg:pt-8">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="pb-24 relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                    <div className="mt-0 mb-6 sm:mt-32 lg:mt-0">
                  ...
                  <div className="mt-6 flex items-center gap-x-6">
                    <a
                        href="/create-job"
                        className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-lg font-semibold text-white shadow-sm hover:bg-indigo-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                        Comenzar ahora
                    </a>
